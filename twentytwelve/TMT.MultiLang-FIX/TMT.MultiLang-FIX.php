 ...
 * theme include file
/*//////////////////////////////////////
require_once('service/service_install.php'); // INSTALL TABLE
...
function add_styles() {
	wp_enqueue_style('tmt_multilang_admin_css', get_bloginfo('template_url').'/TMT.MultiLang-FIX/css/tmt-ui_admin.css');
}

function add_scripts() {
	wp_enqueue_script('jquery-ui-tabs');
	wp_enqueue_script('tmt_multilang_admin_css', get_bloginfo('template_url').'/TMT.MultiLang-FIX/js/tmt-ui_admin-tab.js');
}
...
add_action( 'edit_form_advanced', 'my_second_editor' ); // ADD TAB POST
