...
function add_scripts() {
	...
	<script type="text/javascript">
		var urlselect = '<?php echo $url ?>/TMT.MultiLang-FIX/service/service_sql_select_one.php'; // FOR ADMIN FUNCTION
		var urlupdate = '<?php echo $url ?>/TMT.MultiLang-FIX/service/service_sql_update.php'; // FOR ADMIN FUNCTION
		//console.log(urls);
	</script>
	<?php
